...
IFNULL(SUM(  case_id IS NOT NULL),0) AS my_leads, 
IFNULL(SUM(  case_id IS NULL AND STATUS='Under Process'),0) AS new_leads, 
...
IFNULL(SUM(IF(oi.status='Discrepancy' AND lead_type = 1,1,0)),0) AS discrepancy, 
